...
export const EnergySimulationTable = () => {
  return (
    <div className="overflow-x-auto">
      ...
      <p>
        При смене ценовой категории, рекомендованной ценовым калькулятором, и при снижении потребления мощности в час пиковой нагрузки на 15%, экономия предприятия (по одной точке учета) составляет 84 818 руб. /мес  
      </p>
    </div>
  );
};