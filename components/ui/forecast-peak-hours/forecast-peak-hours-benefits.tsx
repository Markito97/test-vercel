...
return <div>
        ...
        <div className="mt-8 grid grid-cols-12 gap-4">
            <div className="font-bold col-span-12 lg:col-span-4 bg-brand p-4 text-white rounded-xl shadow-xl animate-in fade-in slide-in-from-bottom-10 duration-500">
