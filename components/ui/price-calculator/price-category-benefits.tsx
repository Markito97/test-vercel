...
export const PriceCategoryBenefits = () => {
    return <div >
        ...
        <div className="mt-8 grid grid-cols-12 gap-4">
            <div className="text-center font-bold col-span-12 lg:col-span-5 bg-brand p-4 text-white rounded-xl shadow-xl">
                Расчет ценовых категорий с учетом профиля потребления Вашего предприятия
            </div>
            <div className="text-center font-bold col-span-12 lg:col-span-5 lg:col-start-8 bg-brand p-4 text-white rounded-xl shadow-xl">
